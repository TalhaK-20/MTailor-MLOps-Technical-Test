...
if __name__ == "__main__":
    ...
    try:
        ...
        if predicted_class == 35:
            ...
            print(f" :( Expected class 35, got {predicted_class}, oops !")

    except FileNotFoundError:
        print(f"Image file {img_path} not found, oops :(")
    ...
    try:
        ...
        if predicted_class == 0:
            ...
            print(f"Expected class 0, got {predicted_class} :(")

    except FileNotFoundError:
        print(f"Image file {tench_path} not found.")
    except Exception as e:
        print(f"Error during inference: {e}")